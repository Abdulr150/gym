(function () {
  var STRINGS = {
    en: {
      ...
      'heroCard.callLabel': 'Questions before you join?',
      'hours.Friday': 'Friday',
      ...
      'membership.sub': 'Prices in Bahraini Dinar (BD). The longer the term, the lower your effective monthly rate.',
    ...
    ar: {
      ...
      'heroCard.callLabel': 'أسئلة قبل الانضمام؟',
      'hours.Friday': 'الجمعة',
      ...
      'membership.sub': 'الأسعار بالدينار البحريني (د.ب). كلما طالت مدة الاشتراك، انخفض سعرها الشهري الفعلي.',
      ...
      'plan.cta': 'استفسري عن هذا الاشتراك',
